...
class PaginatedResultsOfUserGroup(object):
    ...
    def __init__(self, results=None, total_number_of_results=None, local_vars_configuration=None):  # noqa: E501
        """PaginatedResultsOfUserGroup - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def results(self):
        """Gets the results of this PaginatedResultsOfUserGroup.  # noqa: E501

        Page of user groups  # noqa: E501

        :return: The results of this PaginatedResultsOfUserGroup.  # noqa: E501
    ...
    def results(self, results):
        """Sets the results of this PaginatedResultsOfUserGroup.

        Page of user groups  # noqa: E501

        :param results: The results of this PaginatedResultsOfUserGroup.  # noqa: E501
        :type: list[UserGroup]
        """
    ...
    def total_number_of_results(self):
        """Gets the total_number_of_results of this PaginatedResultsOfUserGroup.  # noqa: E501
        ...
        :return: The total_number_of_results of this PaginatedResultsOfUserGroup.  # noqa: E501
        :rtype: int
        """
    ...
    def total_number_of_results(self, total_number_of_results):
        """Sets the total_number_of_results of this PaginatedResultsOfUserGroup.

        Calculating the actual totalNumberOfResults is not longer supported. Therefore, for each page, the totalNumberOfResults is estimated using the current page, limit, and offset. When the page size equals the limit, the totalNumberOfResults will be offset+pageSize+ 1. Otherwise, the totalNumberOfResults will be offset+pageSize.   # noqa: E501

        :param total_number_of_results: The total_number_of_results of this PaginatedResultsOfUserGroup.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaginatedResultsOfUserGroup):
            return False
