...
def lazy_import():
    ...
    globals()['NameIdentifierScheme'] = NameIdentifierScheme


class DoiNameIdentifier(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name_identifier_scheme': (NameIdentifierScheme,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, identifier, name_identifier_scheme, *args, **kwargs):  # noqa: E501
        """DoiNameIdentifier - a model defined in OpenAPI
