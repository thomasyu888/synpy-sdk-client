...
class DoiAllOf(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """DoiAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            creators ([DoiCreator]): The main researchers involved in producing the data, or the authors of the publication, in priority order. . [optional]  # noqa: E501
            publication_year (int): The year that this resource became publicly accessible. Must be in YYYY format.. [optional]  # noqa: E501
            resource_type (DoiResourceType): [optional]  # noqa: E501
            titles ([DoiTitle]): A name or title by which a resource is known.. [optional]  # noqa: E501
        """
