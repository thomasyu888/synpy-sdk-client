...
class QueryBundleRequest(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """QueryBundleRequest - a model defined in OpenAPI
