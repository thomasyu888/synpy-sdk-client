...
class EntityBundleV2ServicesApi(object):
    ...
    def create_entity_bundle2(self, **kwargs):  # noqa: E501
        ...
        :param EntityBundleCreateV2 entity_bundle_create_v2:
        ...
        return self.create_entity_bundle2_with_http_info(**kwargs)  # noqa: E501

    def create_entity_bundle2_with_http_info(self, **kwargs):  # noqa: E501
        """Create an entity and associated components with a single POST.  # noqa: E501

        Create an entity and associated components with a single POST. Specifically, this operation supports creation of an Entity, its Annotations, and its ACL.  Upon successful creation, an EntityBundle is returned containing the requested components, as defined by the partsMask in the request object.'   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_entity_bundle2_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method create_entity_bundle2" % key
                )
    ...
    def get_entity_bundle2(self, id, version_number, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_entity_bundle2_with_http_info(id, version_number, **kwargs)  # noqa: E501

    def get_entity_bundle2_with_http_info(self, id, version_number, **kwargs):  # noqa: E501
        """Get an entity at a specific version and its related data with a single POST.   # noqa: E501

        Get an entity at a specific version and its related data with a single POST.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity_bundle2_with_http_info(id, version_number, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_entity_bundle2" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `get_entity_bundle2`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('version_number' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `version_number` when calling `get_entity_bundle2`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/entity/{id}/version/{versionNumber}/bundle2', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
